# Ciao Marco! Benvenuto nel progetto spoki-post-sales

Il tuo branch e' `marco`.
...
**Il branch e' la tua copia di lavoro.** Ognuno ha il suo branch. Il tuo si chiama `marco`. Le modifiche che fai restano nel tuo branch finche' non vengono integrate nel progetto principale.
